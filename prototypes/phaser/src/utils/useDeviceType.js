...
export default function useDeviceType() {
    ...
    useEffect(() => {
        ...
        setTouchEnabled(touch_regex.test(user_agent) || mobile_tablet_regex.test(user_agent.slice(0, 4)))
        setIsMobile(touch_regex.test(user_agent) || mobile_regex.test(user_agent.slice(0, 4)))
    })
