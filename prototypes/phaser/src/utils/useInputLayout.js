...
export default function useInputLayout() {
    ...
    const [touch_enabled, setTouchEnabled] = useState(storage.get('touch_enabled_setting') || false)
    const [is_mobile, setIsMobile] = useState(storage.get('is_mobile_setting') || false)
